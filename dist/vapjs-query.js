...
var stripHexPrefix = __webpack_require__(0).stripHexPrefix;
var isHexPrefixed = __webpack_require__(0).isHexPrefixed;
...
function formatQuantity(value, encode) {
  ...
  if (typeof output === 'object' && value !== null && encode) {
...
function formatData(value, byteLength) {
  ...
  if (typeof value === 'string' && value !== null && isHexPrefixed(value) === false) {
    output = '0x' + value;
  }
...
var createRandomId = __webpack_require__(0)();
